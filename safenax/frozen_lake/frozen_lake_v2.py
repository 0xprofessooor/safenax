...
class FrozenLakeV2(environment.Environment):
    ...
    def reward_fn(
        ...
        # We assume `action` is passed as the continuous `soft_action` probability
        # vector from the Actor network (or a one-hot vector).
        # We take the dot product to get the expected reward.
